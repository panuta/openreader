...
from publication.models import Publisher, Publication, PublicationCategory
...
class Magazine(models.Model):
    ...
    categories = models.ManyToManyField(PublicationCategory, related_name='magazine_categories', null=True)
    ...
    modified_by = models.ForeignKey(User, related_name='magazine_modified_by', null=True)
